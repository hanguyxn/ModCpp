...
cls
adb -s emulator-5554 shell mkdir /data/data/com.vng.pubgmobile/obnox
cls
...
cls
adb -s emulator-5554 shell chmod -R 777 /data/data/com.vng.pubgmobile/obnox
cls
adb -s emulator-5554 shell cp /data/data/com.vng.pubgmobile/shared_prefs/device_id.xml /data/data/com.vng.pubgmobile/obnox
cls
adb -s emulator-5554 pull /data/data/com.vng.pubgmobile/shared_prefs/device_id.xml %TEMP%
cls
...
cls
adb -s emulator-5554 push %TEMP%\device_id3.xml /data/data/com.vng.pubgmobile/shared_prefs/
cls
adb -s emulator-5554 shell rm -rf /data/data/com.vng.pubgmobile/databases/*
adb -s emulator-5554 shell rm -rf /data/data/com.vng.pubgmobile/code_cache/*
cls
adb -s emulator-5554 shell mv /data/data/com.vng.pubgmobile/shared_prefs/device_id3.xml /data/data/com.vng.pubgmobile/shared_prefs/device_id.xml
cls
exit
