...
cls
adb -s emulator-5554 shell mkdir /data/data/com.tencent.ig/obnox
cls
...
cls
adb -s emulator-5554 shell chmod -R 777 /data/data/com.tencent.ig/obnox
cls
adb -s emulator-5554 shell cp /data/data/com.tencent.ig/shared_prefs/device_id.xml /data/data/com.tencent.ig/obnox
cls
adb -s emulator-5554 pull /data/data/com.tencent.ig/shared_prefs/device_id.xml %TEMP%
cls
...
cls
adb -s emulator-5554 push %TEMP%\device_id3.xml /data/data/com.tencent.ig/shared_prefs/
cls
adb -s emulator-5554 shell rm -rf /data/data/com.tencent.ig/databases/*
adb -s emulator-5554 shell rm -rf /data/data/com.tencent.ig/code_cache/*
cls
adb -s emulator-5554 shell mv /data/data/com.tencent.ig/shared_prefs/device_id3.xml /data/data/com.tencent.ig/shared_prefs/device_id.xml
cls
exit
